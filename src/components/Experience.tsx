...
const experiences: Experience[] = [
  {
    ...
    description: [
      'Developing a SaaS-based inventory management system, focusing on design and setup for a streamlined user experience.',
      'Collaborated with cross-functional teams to design new features, resulting in a streamlined UX and faster iteration.']
  },
  {
